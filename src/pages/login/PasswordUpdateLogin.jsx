    ...
    <div className="flex justify-center items-center mainBG min-h-screen ">
      <div className="bg-white p-8 py-16 shadow-lg rounded-lg w-[530px] h-[535px]">
        <div>
          ...
          <h2 className="text-[30px] text-[#222222] font-bold text-center mb-6 mt-4">
            Password Updated Successfully!
          </h2>
          <h6 className="mt-10 lg:mx-14 text-center text-[#4E4E4E] mb-6 text-[18px]">
            ...
            <div className="mb-4">
              <Form.Item>
                <Button
                  type="primary"
                  htmlType="submit"
                  className="w-full mt-10 py-6 text-[18px] font-semibold my-main-button"
                  loading={loading}
                >
